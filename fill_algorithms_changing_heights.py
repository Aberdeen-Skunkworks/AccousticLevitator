...
heights = np.zeros((50,2))
for height_rise in range(0,41):
    ...
    focus_point = [ 0 , 0, (height_rise*2)/1000]
    
    
    if ((height_rise*2)/1000 ) < 0.02:
        calculation_centre_point = [ 0 , 0, 0.02]
    elif ((height_rise*2)/1000 ) > 0.05:
        calculation_centre_point = [ 0 , 0, 0.05]
    else:
        calculation_centre_point = [ 0 , 0, (height_rise*2)/1000]
    ...
    print("At height: ", height_rise)
    heights[height_rise][1] = max_for_this_loop
